AIS subscriber files effective date June 11, 2026.

Dear Subscribers,

For the June 11, 2026 subscriber files, the files incorporate data 
published in the daily National Flight Data Digest (NFDD) through
 
    NFDD 090 dated 05/11/2026.  

The June 11, 2026 cycle is a 28 Day Change Notice Cycle subscriber set. 
...
COMING FORMAT CHANGES:
    ...
    format changes is scheduled for release this year, however, a date has 
    yet to be determined. Once a date is confirmed, Users of the NASR 
    Subscriber Files will be notified. Test NASR subscriber files will be 
    made available to Users in the coming weeks. A Data Product Notice (DPN) 
    will be issued to inform Users of the availability of the TEST 
    Subscriber Files and will provide a link to access the Test Subscribers. 
